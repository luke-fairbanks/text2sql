...
Initially we tried to feed the LLM the structure of our data included in the prompt. While that worked for some prompts, it would get simple issues wrong. We decided to implement few-shot prompting and include various examples of data within the prompt, and this really increased the accuracy. The LLM better understood how our data looked and interacted when it could see examples.